...
│  DoclingController│
│  DoclingJobService│    H2 file-based             ┌─────────────────────┐
│  ParsedDocumentService──────────────────────────►│  H2 Database        │
│  ParsedDocumentController│                       │  ./data/docling-    │
│  SemanticIndexService│                           │  store.mv.db        │
│  HybridSearchService │     embed + index         └─────────────────────┘
│  RagService      │ ──────────────────────────── ►┌─────────────────────┐
│                  │                               │  Elasticsearch      │
│                  │ ◄──────────────────────────── │  :9200              │
│                  │     chunk + score             └─────────────────────┘
